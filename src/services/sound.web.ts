// 音效服務（Web 版；原生版見 sound.ts）
//
// 以 Web Audio API 即時合成：雜訊＋共振模擬象棋落子／搖筒的音色，
// 不需要任何音檔。原生端沒有 Web Audio，改播 assets/sounds/ 下的 WAV，
...
function getCtx(): AudioContext | null {
  ...
  // 靜態匯出的預渲染階段沒有 window，取值會拋 ReferenceError。
  // 原生端不會走到這裡（Metro 會解析到 sound.ts）。
