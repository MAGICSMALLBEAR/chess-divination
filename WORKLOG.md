...
| 項目 | 數值 |
|------|------|
| 原始碼檔案 | 116 個（`src` 的 .ts/.tsx，不含測試） |
| Git Commits | 168 次 ※ |
| Jest 測試 | 1411 個 ※ · 66 套件 · 全部通過 |
...
| 17 | **卦辭（＋大象傳）** | **內容工作**——64 條（含大象傳 128 條）要逐條對維基文庫，比照爻辭的校對方式 | 揭曉頁與卦典目前只有爻辭、沒有本卦／變卦的卦辭；學習模式也可多一副牌 | 只做卦辭，或連大象傳一起；三語皆印原文（沿用爻辭不翻譯） |
...
**目前「我能自己往前推」的候選**：#17 卦辭（內容工作，先定只做卦辭或連大象傳）、#18 成就補齊周邊
（先定門檻）。1／2／4／5／8／9／10／11／12／13／14／15／16 已結案，
