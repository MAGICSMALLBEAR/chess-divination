...
| Git Commits | 140 次 ※ |
| Jest 測試 | 1139 個 ※ · 56 套件 · 全部通過 |
| E2E 測試 | 220 個 ※ · Playwright · mobile + desktop |
| TypeScript | 零錯誤 |
| 頁面 | 15 個 |
| 元件 | 22 個 |
| Hooks | 12 個 |
...
Expo Go 實機測試（`NATIVE_TESTING.md` 25 項）、EAS Build preview、
...
| # | 待辦 | 你要做的 | 之後我能接手 | 成本 |
|---|------|---------|------------|------|
| 3 | **iOS/Android 實機測試** | `npx expo start --go`，手機掃碼；依 `NATIVE_TESTING.md` 驗 25 項 | 依你回報的現象修 | 免費 |
...
完整清單見 `NATIVE_TESTING.md` 第一階段（25 項，已標明 Expo Go 驗得到與驗不到）。
