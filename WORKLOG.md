...
| 14 | **六爻面板命理散文是否翻譯（Session 35 提出）** | 🟢 低 | LiuYaoPanel 的六類命理散文（yaoReading／liuyao／useGod／wenwang）在 en/ja 下仍是中文——命理術語翻譯後會喪失原意。要翻譯需另立術語表，要維持需寫進「刻意不翻譯」清單 |
