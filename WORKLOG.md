...
| Git Commits | 145 次 ※ |
| Jest 測試 | 1166 個 ※ · 57 套件 · 全部通過 |
| E2E 測試 | 222 個 ※ · Playwright · mobile + desktop |
| TypeScript | 零錯誤 |
| 頁面 | 15 個 |
| 元件 | 22 個 |
| Hooks | 12 個 |
...
|---|---|---|---|---|
| 1 | **占驗回訪流程（首頁提示）** | **什麼都不缺** — `pendingVerification()` 早就算得出來，只是沒有出口在首頁 | 兩週後從通知／首頁直接回填結果，提高應驗率資料完整度 | 提醒頻率、是否允許關閉（**首頁提示本身不需要這個決定**） |
