...
技術面無等著實作的項目（Session 62 修完占驗提醒的導頁之後，程式待辦清空）；
其餘皆卡在外部資源（帳號／裝置／付費）或待排程的功能候選，
完整清單見 `WORKLOG.md` 的「未來待辦」。

> **這句話在 S56 之後又被推翻四次**（S57 首頁分享入口、S58 文案寫死的數字、
> S59 首頁空欄位、S62 占驗提醒只導到統計頁），每一次都是在寫下「待辦清空」
> 之後換一種找法才找到的。所以它真正的意思是
> **「上一種找法已經找不到了」**，不是「沒有了」。
